...
function Nav() {
    ...
    return (
        <div className='w-[100vw] h-[70px] bg-[linear-gradient(135deg,#131313_67%,#00A6D4_74%,#890976_85%,#FF5500_95%)] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black'>

            <div className='w-[20%] lg:w-[30%] flex items-center justify-start   gap-[10px] '>
                <img src={logo} alt="" className='w-[50px]' />
                <h1 className='text-[25px] text-[white] font-sans '>ShopAI</h1>
            </div>
            <div className='w-[50%] lg:w-[40%] hidden md:flex'>
                <ul className='flex items-center justify-center gap-[19px] text-[white] '>
                    <li className='text-[15px] hover:bg-slate-500 cursor-pointer bg-[#2c3e50b0] py-[10px] px-[20px] rounded-full' onClick={() => navigate("/")}>HOME</li>
                    <li className='text-[15px] hover:bg-slate-500 cursor-pointer bg-[#2c3e50b0] py-[10px] px-[20px] rounded-full' onClick={() => navigate("/collection")}>COLLECTIONS</li>
                    <li className='text-[15px] hover:bg-slate-500 cursor-pointer bg-[#2c3e50b0] py-[10px] px-[20px] rounded-full' onClick={() => navigate("/about")}>ABOUT</li>
                    <li className='text-[15px] hover:bg-slate-500 cursor-pointer bg-[#2c3e50b0] py-[10px] px-[20px] rounded-full' onClick={() => navigate("/contact")}>CONTACT</li>
                </ul>
            </div>
